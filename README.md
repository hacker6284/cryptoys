...
Each primitive is a directory holding a normative specification and one [sudocode](https://github.com/hacker6284/sudocode) implementation. Demos are rendered with Three.js, and published from this repository with GitHub Pages (and the same generated tree on [cryptoygraphy.com](https://cryptoygraphy.com/) via Render tracking `gh-pages` — see `.github/RENDER.md`). Demos-touching PRs also get a playroom preview at `https://hacker6284.github.io/cryptoys/pr/<N>/` — see `demos/README.md`.
