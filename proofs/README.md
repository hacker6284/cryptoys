...
4. **Link 2 refinement** — algebraic skeleton equals the generated program on the well-formed domain. Started for DoubleDeal (`drop_front` / `push_front`; `passkey` on length ≤ 1). Not emitter soundness (that stays layer-2 TAP / Link 1). See [`LINK2.md`](LINK2.md).
