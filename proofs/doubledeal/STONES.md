...
| S14 | DoubleDeal-CBC-HMAC round-trip and tag reject | **Evidence** | Generated TAP 11/11 (HMAC / KDF / pad) | `primitives/aead/doubledeal-cbc-hmac/` + `proofs/doubledeal-cbc-hmac/lean/Generated/`. Not Link 2. Not a MAC/AEAD theorem. SCM stays later. |
