/-
  ...
  typecheck. Link 2 glues `Generated.passkey` ≃ `passToKeyCutFallback`
  and `Generated.passkey_inv` ≃ `passToKeyCutFallbackInv` on every
  well-formed list. NEXT is encrypt refinement. Do not edit this file
  to "fix encrypt".
-/
