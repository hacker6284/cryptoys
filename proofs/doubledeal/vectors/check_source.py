#!/usr/bin/env python3
"""Fail if doubledeal_vectors.json is stale relative to doubledeal.sudo.
...
JSON_PATH = ROOT / "proofs" / "doubledeal" / "vectors" / "doubledeal_vectors.json"
...
def main() -> int:
    ...
    if got != h:
        print(
            ...
            "regenerate: proofs/doubledeal/vectors/regen.sh",
            file=sys.stderr,
        )
        return 1
