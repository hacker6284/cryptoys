// Collect DoubleDeal known-answer vectors from a sudoc JS build of
// primitives/cipher/doubledeal/doubledeal.sudo. Do not hand-edit the JSON this
...
const impl = await import(pathToFileURL(path.resolve(outDir, "_doubledeal_impl.mjs")).href);
const api = await import(pathToFileURL(path.resolve(outDir, "doubledeal.mjs")).href);
...
const doc = {
  schema: 1,
  generated_by: "proofs/doubledeal/vectors/regen.sh",
  source: "primitives/cipher/doubledeal/doubledeal.sudo",
  sudo_sha256: sudoSha,
