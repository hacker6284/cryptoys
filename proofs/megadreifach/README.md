...
| — | Full `Generated.v_Hash` refinement; Scramble algebraic ≃ Generated | OPEN. Pad, `compose`, `require_permutation`, `pack_ori2`, and `pack_ori3` slices are closed. `phi_chunk` / `phi_inv` are still open. Not collision resistance. |
